...
add_interface user_if conduit end
set_interface_property user_if associatedClock device_clock
add_interface_port user_if usr_ctrl_reg usr_ctrl_reg Input 8
add_interface_port user_if usr_tx_data_sel usr_tx_data_sel Input 1
add_interface_port user_if usr_tx_data_i usr_tx_data_i Input 12
add_interface_port user_if usr_tx_data_q usr_tx_data_q Input 12
add_interface_port user_if usr_tx_frame  usr_tx_frame  Input 1
