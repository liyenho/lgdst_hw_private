...
# ACDS 15.0 153 win32 2016.01.10.02:21:26
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If tx_clk_gen2 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "tx_clk_gen2"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/tx_clk_gen2.vo"
}
