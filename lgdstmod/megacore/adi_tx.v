...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=7 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="TRUE" USE_OE="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataout dataout_b
...
//synthesis_resources = cyclonev_io_obuf 7 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  adi_tx_iobuf_out_4lt
	( 
	datain,
	dataout,
	dataout_b) ;
	...
	assign
		...
		oe_w = {7{1'b1}};
endmodule //adi_tx_iobuf_out_4lt
//VALID FILE
...
module adi_tx (
	...
	wire [6:0] dataout_b = sub_wire1[6:0];

	adi_tx_iobuf_out_4lt	adi_tx_iobuf_out_4lt_component (
				.datain (datain),
				.dataout (sub_wire0),
				.dataout_b (sub_wire1));
